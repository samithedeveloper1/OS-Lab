...
print("Process\tArrivalTime\tBurstTime\tCompletionTime\tTurnaroundTime\tWaitingTim e") 
for i in range(n): 
  
print(f"{processes[i]}\t\t{arrival_times[i]}\t\t{burst_times[i]}\t\t{completion_time[i]}\t\t{turnar ound_time[i]}\t\t{waiting_time[i]}")
